        ...
        <section id="stories" className="px-5 py-16 sm:px-8 lg:py-20">
          <div className="mx-auto max-w-[1160px]">
            ...
            <div className="mt-10 grid gap-5 md:grid-cols-3">
              <article className="overflow-hidden rounded-[20px] border border-[#22323A]/[0.07] bg-white/45"><div className="relative aspect-[4/3]"><Image src="/testimonials/customer-london.jpg" alt="Matt L., London" fill className="object-cover" sizes="(max-width:768px) 100vw, 33vw" /></div><div className="p-6"><blockquote className="font-serif text-[20px] leading-[1.42]">“I gave it to my partner for her birthday. <strong className="font-semibold text-[#17232A]">She cried within seconds.</strong> It felt deeply personal — not just another gift.”</blockquote><p className="mt-4 text-[11px] text-[#22323A]/55">— Matt L., London</p></div></article>
              <article className="overflow-hidden rounded-[20px] border border-[#22323A]/[0.07] bg-white/45"><div className="relative aspect-[4/3]"><Image src="/testimonials/customer-newyork.jpg" alt="Sophie M., New York" fill className="object-cover" sizes="(max-width:768px) 100vw, 33vw" /></div><div className="p-6"><blockquote className="font-serif text-[20px] leading-[1.42]">“Such a simple idea, but <strong className="font-semibold text-[#17232A]">incredibly powerful.</strong> The moment we unlocked the message together, it became something we’ll remember.”</blockquote><p className="mt-4 text-[11px] text-[#22323A]/55">— Sophie M., New York</p></div></article>
              <article className="overflow-hidden rounded-[20px] border border-[#22323A]/[0.07] bg-white/45"><div className="relative aspect-[4/3] overflow-hidden bg-[#EFE8DF]"><img src="/testimonials/customer-phone-live.jpg" alt="A real UNIKMO recipient smiling while viewing a private moment on her phone" className="absolute inset-0 h-full w-full object-cover" /></div><div className="p-6"><p className="text-[10px] font-semibold uppercase tracking-[0.2em] text-[#B38846]">Real recipient moment</p><p className="mt-3 font-serif text-[20px] leading-[1.42]">The product disappears. <strong className="font-semibold text-[#17232A]">What remains is the reaction.</strong></p></div></article>
            </div>
          </div>
        </section>
